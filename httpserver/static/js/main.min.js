...
`+n.text.split(`
`).map(c=>"    "+c).join(`
`):n.text;return`${t} [${n.tag}]: ${a}`}return`${t}: ${s}`}let o=D(s);if(o){let n=o.text.includes(`
`)?`
`+o.text.split(`
`).map(a=>"    "+a).join(`
